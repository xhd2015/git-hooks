...
- Stdout confirms hook added (`Added pre-push hook: outside-push`).
...
- Managed hook exists at `$XDG_CONFIG_HOME/.git-hooks/pre-push.d/outside-push`.
...
func Assert(t *testing.T, req *Request, resp *Response, err error) {
	...
	if !strings.Contains(resp.AddOutput, "Added pre-push hook: outside-push") {
	...
	managedPath := filepath.Join(globalManagedDir(req, "pre-push"), "outside-push")
